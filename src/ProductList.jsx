...
function ProductList() {
    ...
    const cartItems = useSelector((state) => [...state.cart.items]); // Forces a new reference
...
const handleAddToCart = (plant) => {
    dispatch(addItem(plant)); // Assuming Redux is handling cart state

    //setAddedToCart((prev) => [...prev, plant.name]); // Update addedToCart state
  ...
  useEffect(() => {
    //console.log("cartItems updated:", cartItems); // Debugging cartItems change
    ...
    // Use a function inside setState to ensure we log the updated state
    setAddedToCart((updatedCart) => {
        //console.log("useEffect Updated addedToCart:", updatedCart);
        return updatedCart;
    });
}, [cartItems]);
    ...
    <div key={index}>
        ...
        <div className="product-list">
            ...
            <div className="product-card" key={plantIndex}>
                ...
                <button  className={`product-button ${addedToCart.includes(plant.name) ? 'disabled' : ''}`}  onClick={() => handleAddToCart(plant)} disabled={addedToCart.includes(plant.name)}>{addedToCart.includes(plant.name) ? "Added" : "Add to Cart"}</button>
            </div>
            ))}
        </div>
    </div>
